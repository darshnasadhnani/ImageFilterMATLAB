...
prewittX_mask=[-1 0 1;-1 0 1; -1 0 1];
prewittY_mask=[1 1 1;0 0 0;-1 -1 -1];
...
lowpass_imag_1 = lowpass_filter(img, 25);
lowpass_imag_2 = lowpass_filter(img, 50);
...
high_fre_result = high_freq_emphasis(img, 0.4, 0.6);
